          ...
          >
            ...
            <div className="relative bg-white/80 backdrop-blur-md rounded-3xl border border-gray-200/50 p-6 shadow-2xl overflow-hidden aspect-4/5 flex flex-col">
              ...
              <div className="grow pt-6 flex flex-col gap-6 overflow-auto">
                {/* User Question */}
                <div
                  className="flex flex-col items-end gap-2 ml-12 animate-fade-in"
                ...
                {/* AI Response 1 */}
                <div
                  className="flex flex-col items-start gap-2 mr-12 animate-fade-in"
                  style={{ animationDelay: "0.7s" }}
                >
                  <div className="text-white p-4 rounded-2xl bg-primary rounded-tl-none text-sm shadow-md hover:shadow-lg transition-shadow leading-relaxed">
                ...
                >
                  <div className="bg-primary text-white p-4 rounded-2xl rounded-tl-none text-sm shadow-md hover:shadow-lg transition-shadow font-medium">
                  ...
                  <div className="px-3 py-1 mt-2 mx-auto bg-green-500/10 text-green-600 rounded-full text-[10px] font-bold flex items-center gap-1">
