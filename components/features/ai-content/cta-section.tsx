  ...
  return (
    <section className="py-24 bg-gray-50">
      <div ref={ref} className="container mx-auto px-6">
        <div
          className={`bg-tertiary text-white rounded-3xl p-12 md:p-16 text-center relative overflow-hidden shadow-2xl max-w-5xl mx-auto transition-all duration-700 ${
