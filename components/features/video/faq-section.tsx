...
const faqs = [
  {
    questionKey: "featurePage.video.faq.1.question",
    answerKey: "featurePage.video.faq.1.answer",
  },
  {
    questionKey: "featurePage.video.faq.2.question",
    answerKey: "featurePage.video.faq.2.answer",
  },
  {
    questionKey: "featurePage.video.faq.3.question",
    answerKey: "featurePage.video.faq.3.answer",
  },
  {
    questionKey: "featurePage.video.faq.4.question",
    answerKey: "featurePage.video.faq.4.answer",
  },
];
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center gap-3 mb-4">
            <div className="w-12 h-12 rounded-xl bg-linear-to-br from-[#5fffec] to-[#008bff] flex items-center justify-center shadow-lg shadow-[#22b5f8]/25">
              <HelpCircle className="w-6 h-6 text-white" />
            </div>
          </div>
          <h2 className="text-3xl md:text-4xl font-extrabold mb-3">
            <span className="bg-linear-to-r from-[#5fffec] to-[#008bff] bg-clip-text text-transparent">
              {t("featurePage.video.faq.title")}
            </span>
          </h2>
          <p className="text-muted-foreground text-lg">
            {t("featurePage.video.faq.subtitle")}
          </p>
        </div>
