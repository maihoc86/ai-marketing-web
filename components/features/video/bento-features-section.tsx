        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="p-8">
              ...
              <LocaleLink
                href="/#features"
                className="inline-flex items-center gap-1 mt-4 text-primary font-bold text-sm group-hover:underline"
              >
            ...
            <div className="flex-1 relative overflow-hidden px-8 pb-8">
              <div className="flex items-center -space-x-4 opacity-70 group-hover:opacity-100 transition-opacity duration-500">
                <div className="size-16 rounded-full bg-linear-to-br from-pink-200 to-pink-400 flex items-center justify-center shadow-lg ring-4 ring-white">
                  <UserCircle className="size-10 text-white" />
                </div>
                <div className="size-16 rounded-full bg-linear-to-br from-blue-200 to-blue-400 flex items-center justify-center shadow-lg ring-4 ring-white">
                  <UserCircle className="size-10 text-white" />
                </div>
                <div className="size-16 rounded-full bg-linear-to-br from-purple-200 to-purple-400 flex items-center justify-center shadow-lg ring-4 ring-white">
                  <UserCircle className="size-10 text-white" />
                </div>
                <div className="flex items-center justify-center size-16 rounded-full bg-gray-100 border-2 border-dashed border-gray-300 text-gray-400 text-xs font-bold ring-4 ring-white">
                  +100
                </div>
              </div>
            </div>
          ...
          >
            <div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-40 transition-opacity">
              <Mic2 className="size-14 text-primary" />
            </div>
          ...
          >
            <div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-40 transition-opacity">
              <Scissors className="size-14 text-primary" />
            </div>
            <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4">
          ...
          >
            <div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-40 transition-opacity">
              <Languages className="size-14 text-primary" />
            </div>
            <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4">
          ...
          >
            <div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-40 transition-opacity">
              <LayoutGrid className="size-14 text-primary" />
            </div>
            <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4">
            ...
            <div className="grid grid-cols-3 gap-1.5">
              ...
              <div className="aspect-video bg-primary/10 rounded-sm flex items-center justify-center border-2 border-primary/60">
                <span className="text-[8px] text-primary font-bold">02</span>
              </div>
              <div className="aspect-video bg-gray-200 rounded-sm flex items-center justify-center">
