            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative flex-1">
                <Input
                  ...
                  className="h-14 pr-36 px-6 rounded-full bg-white border-0 text-gray-900 placeholder:text-gray-400 text-base w-full shadow-lg"
                  required
                />
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="absolute right-2 top-1/2 -translate-y-1/2 h-12 px-5 rounded-full bg-[#ff7900] text-white hover:bg-[#e56b00] font-semibold text-base shadow-lg shadow-[#ff7900]/30 hover:shadow-xl transition-all duration-200"
                >
                  {t("cta.button")}
