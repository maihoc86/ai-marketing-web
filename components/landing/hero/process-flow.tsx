...
const PlatformIcon = memo(({ platform }: { platform: Platform }) => (
  <div className="flex items-center justify-center p-2.5 rounded-lg bg-white border border-gray-200 hover:border-violet-300 hover:shadow-md transition-all duration-200 cursor-pointer group/icon">
    <platform.Icon
    ...
    <div className="mt-20 md:mt-28">
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/30 backdrop-blur-sm">
          ...
          <span className="text-xs font-medium text-[#008bff]">
            {t("process.badge")}
          </span>
        </div>
      </div>
      ...
      <div className="relative">
        ...
        <div className="hidden lg:block absolute top-1/2 left-0 right-0 -translate-y-1/2 z-0">
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, #2563eb 0%, #3b82f6 33%, #60a5fa 66%, #93c5fd 100%)",
                opacity: 0.3,
              }}
            />
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 0 20px rgba(37, 99, 235, 0.8), 0 0 40px rgba(59, 130, 246, 0.4)",
        ...
        <div className="lg:hidden absolute left-1/2 top-0 bottom-0 -translate-x-1/2 w-[2px] z-0">
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, #2563eb, #3b82f6, #60a5fa, #93c5fd)",
              opacity: 0.3,
            }}
          />
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(37, 99, 235, 0.1), rgba(37, 99, 235, 0.2))",
                    boxShadow:
                      "0 0 20px rgba(37, 99, 235, 0), inset 0 1px 0 rgba(255,255,255,0.5)",
                  }}
                >
                  <Lightbulb
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-start space-y-2">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(59, 130, 246, 0.05), rgba(59, 130, 246, 0.1))",
                  }}
                >
                  <ImageIcon className="w-4 h-4 text-[#22b5f8]" />
                  <span className="text-xs font-medium text-gray-700">
                    {t("process.step3.image")}
                  </span>
                </div>
                <div
                  className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 transition-all duration-200 hover:border-emerald-300 hover:shadow-sm cursor-pointer"
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(139, 92, 246, 0.1), rgba(139, 92, 246, 0.2))",
                  }}
                >
                  <Share2
