          ...
          <div className="relative lg:pl-8">
            <div className="relative">
              ...
              >
                ...
                <div className="p-6 bg-linear-to-br from-gray-50 to-white min-h-[400px]">
                  {/* Dashboard header */}
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <h4 className="font-semibold text-gray-900">
                        {t("whyChoose.mockup.title")}
                      </h4>
                      <p className="text-sm text-gray-500">
                        {t("whyChoose.mockup.subtitle")}
                      </p>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                      ...
                      <div className="text-xs text-gray-500">
                        {t("whyChoose.mockup.videos")}
                      </div>
                    </div>
                    <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                      <div className="text-2xl font-bold text-primary">97%</div>
                      <div className="text-xs text-gray-500">
                        {t("whyChoose.mockup.accuracy")}
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center">
                      <div className="flex -space-x-2">
                        {[1, 2, 3, 4, 5].map((i) => (
                          <div
                            key={i}
                            className="w-8 h-8 rounded-full bg-linear-to-br from-primary/20 to-primary/40 border-2 border-white flex items-center justify-center text-xs font-medium text-primary"
                          >
              ...
              <div className="absolute -inset-4 bg-linear-to-br from-primary/20 via-cyan-500/10 to-purple-500/10 rounded-3xl blur-2xl -z-10" />
            </div>
          </div>
        </div>
      </div>
