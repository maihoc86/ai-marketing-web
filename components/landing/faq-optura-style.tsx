...
export function FaqOpturaStyle() {
  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-32 bg-gradient-optura-subtle relative overflow-hidden font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 mb-6 shadow-optura">
            <HelpCircle className="w-8 h-8 text-white" />
          </div>
          <h2 className="font-serif text-display-md font-bold text-gray-900 mb-4">
            {t("faq.title") || "Câu hỏi"}{" "}
            <span className="italic text-gradient">{t("faq.titleHighlight") || "thường gặp"}</span>
          </h2>
          <p className="text-lg md:text-xl text-gray-700">
            {t("faq.subtitle") || "Tìm câu trả lời cho những câu hỏi phổ biến nhất"}
          </p>
        </div>
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      isOpen
                        ? "bg-gradient-to-br from-blue-500 to-cyan-500 text-white shadow-optura"
                  ...
                  <div className="flex-1">
                    <h3
                      className={cn(
                        ...
                        isOpen ? "text-gradient" : "text-gray-900 group-hover:text-blue-600"
                      )}
                    >
                      {t(faq.questionKey)}
                    </h3>
                  ...
                  >
                    <ChevronDown className={cn("w-5 h-5 transition-colors", isOpen ? "text-blue-600" : "text-gray-600")} />
                  </div>
                </button>
